...
export default function SessionsTab({ loading }: SessionsTabProps) {
  ...
  const revokeAllOtherSessions = async () => {
    if (
      !confirm("¿Estás seguro de que quieres cerrar todas las demás sesiones?")
    ) {
      return;
    }
    ...
    try {
      ...
      await loadSessions();
      toast.success(
        result.message || "Todas las demás sesiones han sido cerradas"
      );
    } catch (error) {
      console.error("Error:", error);
      toast.error(
        error instanceof Error
          ? error.message
          : "Error al cerrar sesiones. Por favor, inténtalo de nuevo."
      );
    }
  };
                        ...
                        <div className="ml-4">
                          ...
                          <div className="mt-1 text-sm text-gray-500">
                            ...
                            <div className="flex items-center mt-1">
                              ...
                              <span>
                                ID: {session.clientId || "Desconocido"}
                              </span>
                            </div>
                          </div>
                        </div>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-blue-700">
                <p>
                  Si ves una sesión que no reconoces, cierra la sesión de ese
                  dispositivo y cambia tu contraseña de inmediato.
                </p>
                <button
                  type="button"
      ...
      <div className="bg-white shadow sm:rounded-lg">
        <div className="px-4 py-5 sm:p-6">
          ...
          <div className="mt-2 max-w-xl text-sm text-gray-500">
            <p>
              Para mayor seguridad, te recomendamos cambiar tu contraseña
              regularmente y no compartir tus credenciales de inicio de sesión.
            </p>
          </div>
          <div className="mt-5">
            <button
              type="button"
              onClick={() =>
                (window.location.href = "/dashboard/settings/cuenta")
              }
