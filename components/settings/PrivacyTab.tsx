...
export default function PrivacyTab({ loading }: PrivacyTabProps) {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h3 className="text-lg font-medium text-gray-900 mb-4">Privacidad de Datos</h3>
              ...
              <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                  ...
                  <p className="mt-2 text-xs text-gray-500">
                    Descarga una copia de todos tus datos personales en el formato seleccionado.
                  </p>
                </dd>
              </div>
                ...
                <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                  <div className="max-w-lg">
                    <p className="text-sm text-gray-700 mb-3">
                      Al eliminar tu cuenta, todos tus datos personales serán eliminados permanentemente. Esta acción no se puede deshacer.
                    </p>
                    <div className="mt-2">
                    ...
                    <div className="mt-4">
                      <button
                        ...
                        disabled={deleteConfirmation !== 'DELETE MY DATA' || loading}
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-yellow-700">
              Nos tomamos muy en serio la privacidad de tus datos. Si tienes alguna pregunta sobre cómo manejamos tu información, por favor consulta nuestra <a href="/politica-privacidad" className="font-medium underline text-yellow-700 hover:text-yellow-600">Política de Privacidad</a>.
            </p>
          </div>
        </div>
      </div>
