        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-400 font-workSans text-sm">
              El portal exclusivo para despachos de abogados. Conectamos
              profesionales del derecho con clientes que necesitan sus
              servicios.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link
                  href="/sobre-nosotros"
                  className="text-gray-400 hover:text-white transition-colors font-workSans"
                >
                  Sobre Nosotros
                </Link>
              </li>
          ...
          {/* Despachos */}
          <div>
            <h4 className="text-lg font-bold font-workSans mb-4">
              Para Despachos
            </h4>
            <ul className="space-y-2 text-sm">
              <li>
