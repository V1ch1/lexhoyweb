...
export default function SolicitudesDespacchosPage() {
  ...
  const [selectedSolicitud, setSelectedSolicitud] =
    useState<SolicitudExtendida | null>(null);
  ...
  const loadSolicitudes = useCallback(async () => {
    try {
      ...
      const solicitudesConDatos: SolicitudExtendida[] = data.map(
        (solicitud: SolicitudExtendida) => ({
          ...solicitud,
          usuario: {
          ...
          despachoNombre:
            solicitud.despacho_nombre || String(solicitud.despacho_id),
  ...
  // Eliminada la llamada automática a loadSolicitudes en useEffect
          ...
          {solicitudes.length === 0 ? (
            <div className="p-12 text-center">
              ...
              <p className="text-gray-500">
                Todas las solicitudes de asignación de despachos han sido
                procesadas.
              </p>
            </div>
          ) : (
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-3">
                        <h3 className="text-lg font-medium text-gray-900">
                          {solicitud.usuario?.nombre || solicitud.user_id}{" "}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm font-medium">
                            {(() => {
                              const fechaLocal = solicitud.fecha_solicitud
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Solicitud de{" "}
                {selectedSolicitud.usuario?.nombre || selectedSolicitud.user_id}{" "}
                {selectedSolicitud.usuario?.apellidos || ""}
                para el despacho{" "}
                {selectedSolicitud.despacho?.nombre ||
                  selectedSolicitud.despacho_id}
              </p>
              <div className="mb-4">
