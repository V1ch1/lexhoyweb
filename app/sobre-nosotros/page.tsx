...
export const metadata: Metadata = {
  ...
  description: "Conoce la historia, misión y equipo detrás de Lexhoy.com, el principal portal de noticias jurídicas y directorio de despachos de abogados en España.",
};
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 font-workSans max-w-3xl mx-auto">
              Somos el principal portal de información jurídica y directorio de despachos de abogados en España, 
              conectando profesionales del derecho con clientes que necesitan sus servicios.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 font-workSans">
                Facilitar el encuentro entre despachos de abogados especializados 
                y clientes que necesitan servicios jurídicos específicos.
              </p>
            </div>
            <div className="text-center">
              <div className="bg-primary/10 p-6 rounded-full w-20 h-20 mx-auto mb-4 flex items-center justify-center">
      ...
      <section className="bg-primary py-16">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <p className="text-xl text-white/90 font-workSans mb-8">
            Únete a más de 10.000 despachos que ya confían en Lexhoy para hacer crecer su negocio.
          </p>
          ...
          <div className="border-t border-white/20 pt-8">
            <p className="text-white/90 font-workSans mb-4">
              Síguenos en nuestras redes sociales para estar al día con las últimas noticias jurídicas
            </p>
            <div className="flex justify-center space-x-6">
              <a href="https://www.facebook.com/lexhoynoticias/" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-white transition-colors">
                <span className="sr-only">Facebook</span>
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M20 10C20 4.477 15.523 0 10 0S0 4.477 0 10c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V10h2.54V7.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V10h2.773l-.443 2.89h-2.33v6.988C16.343 19.128 20 14.991 20 10z" clipRule="evenodd" />
                </svg>
              </a>
              <a href="https://www.instagram.com/lexhoynoticias/" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-white transition-colors">
              ...
              <a href="https://www.linkedin.com/company/lex-hoy/about/" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-white transition-colors">
                <span className="sr-only">LinkedIn</span>
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.338 16.338H13.67V12.16c0-.995-.017-2.277-1.387-2.277-1.39 0-1.601 1.086-1.601 2.207v4.248H8.014v-8.59h2.559v1.174h.037c.356-.675 1.227-1.387 2.526-1.387 2.703 0 3.203 1.778 3.203 4.092v4.711zM5.005 6.575a1.548 1.548 0 11-.003-3.096 1.548 1.548 0 01.003 3.096zm-1.337 9.763H6.34v-8.59H3.667v8.59zM17.668 1H2.328C1.595 1 1 1.581 1 2.298v15.403C1 18.418 1.595 19 2.328 19h15.34c.734 0 1.332-.582 1.332-1.299V2.298C19 1.581 18.402 1 17.668 1z" clipRule="evenodd" />
                </svg>
              </a>
              <a href="https://www.tiktok.com/@lexhoy" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-white transition-colors">
                <span className="sr-only">TikTok</span>
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-5.2 1.74 2.89 2.89 0 012.31-4.64 2.93 2.93 0 01.88.13V9.4a6.84 6.84 0 00-.88-.05A6.33 6.33 0 005 20.1a6.34 6.34 0 0010.86-4.43v-7a8.16 8.16 0 004.77 1.52v-3.4a4.85 4.85 0 01-1-.1z"/>
                </svg>
              </a>
              <a href="https://www.youtube.com/@LexHoy" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-white transition-colors">
