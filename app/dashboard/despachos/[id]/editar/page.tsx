  ...
  useEffect(() => {
    const fetchNombre = async () => {
      ...
      try {
        ...
        const res = await fetch(`https://lexhoy.com/wp-json/wp/v2/despacho/${despachoId}`, {
          headers: {
  ...
  return (
    <div className="p-6">
      <div className="mb-6 flex items-center justify-between gap-4">
        <h1 className="text-3xl font-bold text-gray-900 truncate">{nombreDespacho || "Editar Despacho"}</h1>
        <button
