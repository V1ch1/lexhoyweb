...
export default function LeadDetailPage() {
  ...
  const handleBuy = async () => {
    if (!lead) return;
    if (!confirm(`¿Estás seguro de comprar este lead por ${lead.precio_base}€?`))
      return;
            ...
            <div className="mb-8">
              ...
              <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-gray-50 p-3 rounded text-center">
                  <div className="text-xs text-gray-500 uppercase">Calidad</div>
                  <div className="font-bold text-gray-900 text-lg">{lead.puntuacion_calidad}/100</div>
                </div>
                <div className="bg-gray-50 p-3 rounded text-center">
                  <div className="text-xs text-gray-500 uppercase">Detalle</div>
                  <div className="font-bold text-gray-900 capitalize">{lead.nivel_detalle}</div>
                </div>
                <div className="bg-gray-50 p-3 rounded text-center">
                   <div className="text-xs text-gray-500 uppercase">Ciudad</div>
                   <div className="font-bold text-gray-900">{lead.ciudad || "-"}</div>
                </div>
              </div>
            </div>
          )}
