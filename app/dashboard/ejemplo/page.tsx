          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  €{mockLeads.reduce((sum, lead) => sum + (lead.presupuestoEstimado || 0), 0).toLocaleString()}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow">
            <div className="px-6 py-4 border-b border-gray-200">
              <h3 className="text-lg font-medium text-gray-900">Leads Recientes</h3>
            </div>
                      ...
                      <div className="flex items-center mt-1 space-x-2">
                        <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                          ...
                          {lead.estado === 'nuevo' ? 'Nuevo' : 
                           lead.estado === 'contactado' ? 'Contactado' : 'Cerrado'}
                        </span>
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex flex-col items-end space-y-1">
                      <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                        ...
                        {sede.estado_verificacion === 'verificado' ? 'Verificada' :
                         sede.estado_verificacion === 'pendiente' ? 'Pendiente' : 'Rechazada'}
                      </span>
            ...
            <div className="ml-4">
              ...
              <div className="mt-2 text-sm text-blue-800">
                ...
                <ul className="list-disc list-inside space-y-1 ml-4">
                  <li>TypeScript interfaces actualizadas con estructura Algolia</li>
                  <li>Servicio Supabase configurado con métodos CRUD</li>
                  <li>Schema SQL completo con tablas, índices y políticas RLS</li>
                ...
                <div className="mt-4 p-3 bg-blue-100 rounded">
                  <p className="text-xs text-blue-700">
                    <strong>Nota:</strong> Este dashboard muestra datos de ejemplo. 
                    Una vez configurado Supabase, se conectará automáticamente con datos reales.
                    Consulta <code>docs/SUPABASE_SETUP.md</code> para la configuración completa.
                  </p>
                </div>
              </div>
            </div>
